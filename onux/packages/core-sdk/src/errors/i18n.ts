...
const MESSAGES: Messages = {
  ...
  5000: {
    ...
    fr: "Le pairing WalletConnect n'a pas pu être établi.",
  ...
  5002: {
    ...
    es: 'La sesión de WalletConnect ha expirado. Vuelva a conectar.',
    fr: 'La session WalletConnect a expiré. Veuillez vous reconnecter.',
  ...
  5006: {
    ...
    es: 'Ocurrió un error a nivel de protocolo WalletConnect.',
  ...
  5007: {
    ...
    es: 'Se perdió la conexión del relay de WalletConnect.',
    fr: 'La connexion au relay WalletConnect a été perdue.',
  ...
  5008: {
    ...
    es: 'La solicitud de WalletConnect agotó el tiempo.',
    fr: "La demande WalletConnect a expiré.",
