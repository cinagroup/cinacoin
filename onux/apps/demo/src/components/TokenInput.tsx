      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none bg-[var(--cc-canvas-soft-2)] hover:bg-[var(--cc-muted)]/80 rounded-[6px] px-3 py-2 transition-colors border border-[var(--cc-hairline)] text-sm text-[var(--cc-ink)] font-semibold cursor-pointer pr-8 h-[40px]"
          >
            {tokens.map((t) => (
