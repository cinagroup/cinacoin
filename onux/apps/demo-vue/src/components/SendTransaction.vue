...
.gas-value { font-size: 0.85rem; color: var(--cc-link, #38bdf8); font-family: 'SF Mono', monospace; }
...
.result-value { font-size: 0.8rem; color: var(--cc-success, #22c55e); word-break: break-all; line-height: 1.5; }
