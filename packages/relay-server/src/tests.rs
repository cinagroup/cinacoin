...
mod crypto_tests {
    ...
    #[test]
    fn keypair_generates_different_keys_each_time() {
    ...
    #[test]
    fn public_key_from_wrong_length_hex_fails() {
    ...
    #[test]
    fn diffie_hellman_shared_secret_symmetric() {
    ...
    fn encrypt_decrypt_roundtrip() {
        ...
        // Encrypted output is base64(nonce(12) || ciphertext || tag(16))
...
mod message_parsing_tests {
    use crate::models::{RelayMessage, MessageType, RelayAck, RelayError, validate_topic};
...
mod topic_validation_tests {
    ...
    #[test]
    fn valid_mixed_case_hex_passes() {
...
mod subscription_tests {
    use crate::relay::{AppState, TopicMeta};
...
#[cfg(test)]
mod routing_tests {
    use crate::models::{MessageType, RelayMessage};

    #[test]
    fn publish_message_constructor() {
        let topic = "a".repeat(64);
    ...
    #[test]
    fn subscribe_message_constructor() {
        let topic = "b".repeat(64);
    ...
    #[test]
    fn unsubscribe_message_constructor() {
        let topic = "c".repeat(64);
