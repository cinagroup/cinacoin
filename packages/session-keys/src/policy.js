...
export class SessionKeyPolicyManager {
     ...
     */
    static createDexPolicy(dexRouter, maxAmountPerTx, dailyLimit, expiresAt, chainId) {
        return {
            expiresAt,
     ...
     */
    static createNftMintPolicy(nftContract, maxMintPrice, maxMintsPerDay, expiresAt, chainId) {
        return {
            expiresAt,
     ...
     */
    static createOpenPolicy(expiresAt, dailyLimit, chainId) {
        return {
            expiresAt,
            allowedTargets: [],
            allowedMethods: [],
