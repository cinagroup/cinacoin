...
describe('SessionKeyManager', () => {
    ...
    it('should set default 24h expiration when no policy provided', () => {
        ...
        expect(key.expiresAt).toBeLessThanOrEqual(now + 86400);
    });
    ...
    it('should throw when signing with unknown key', async () => {
        await expect(manager.signWithKey('0x0000000000000000000000000000000000000000', 'msg')).rejects.toThrow('Session key not found');
    });
