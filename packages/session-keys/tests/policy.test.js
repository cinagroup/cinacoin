...
describe('Policy presets', () => {
    it('should create a DEX policy with correct defaults', () => {
        const params = SessionKeyPolicyManager.createDexPolicy('0xDexRouter', 100n, 1000n, Math.floor(Date.now() / 1000) + 86400, 1);
    ...
    it('should create an NFT mint policy with correct defaults', () => {
        const params = SessionKeyPolicyManager.createNftMintPolicy('0xNFTContract', 50n, 10, Math.floor(Date.now() / 1000) + 86400, 1);
    ...
    it('should create an open policy with no restrictions', () => {
        const params = SessionKeyPolicyManager.createOpenPolicy(Math.floor(Date.now() / 1000) + 86400, 1000n, 1);
