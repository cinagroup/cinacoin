...
export class MultiwalletStore {
     ...
     */
    addConnection(walletId, walletName, namespace, address, provider, session) {
        const now = new Date();
