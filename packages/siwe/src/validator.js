 ...
 */
export function validateSIWEParams(params) {
    const errors = [];
 ...
 */
export function validateTemporalConstraints(data, now = new Date()) {
    const errors = [];
 ...
 */
export function validateDomainMatch(requestDomain, messageDomain) {
    try {
 ...
 */
export function fullValidation(data, signature, requestDomain) {
    const errors = [];
