...
describe('generateMessage', () => {
    ...
    it('should generate timestamp when issuedAt is not provided', () => {
        ...
        const message = generateMessage(rest);
...
describe('parseMessage', () => {
    ...
    it('should throw on missing preamble', () => {
        expect(() => parseMessage('This is not a SIWE message')).toThrow('Invalid SIWE message: missing or malformed preamble');
    });
    it('should throw on missing address', () => {
        expect(() => parseMessage('example.com wants you to sign in with your Ethereum account:\nnot-an-address\n\nURI: https://example.com\nVersion: 1\nChain ID: 1\nNonce: abcdefgh\nIssued At: 2025-01-01T00:00:00.000Z')).toThrow('Invalid SIWE message: missing or malformed address');
    });
    it('should throw on missing URI field', () => {
        expect(() => parseMessage('example.com wants you to sign in with your Ethereum account:\n0x1234567890abcdef1234567890abcdef12345678\n')).toThrow('Invalid SIWE message: missing URI field');
    });
    it('should throw on missing required fields (nonce, chainId)', () => {
        ...
        expect(() => parseMessage(message)).toThrow('Invalid SIWE message: missing required fields');
    });
    it('should throw on invalid Chain ID (non-numeric)', () => {
        ...
        expect(() => parseMessage(message)).toThrow('Invalid SIWE message: Chain ID must be a number');
    });
