#!/usr/bin/env node
/**
 * Build script for @onchainux/design-tokens
 *
...
function build() {
  ...
  const cssContent = [
    '/**',
    ' * OnChainUX Design Tokens — Generated CSS Variables',
...
export { cssVariables, cssVariablesLight, cssVariablesMinimal, themes, tokens, global, semantic, components } from '../src/index';
`;
