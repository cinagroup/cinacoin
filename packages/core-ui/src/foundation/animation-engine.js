...
export function getAnimationTiming(el, theme = 'dark') {
 ...
 */
export async function animate(element, preset, config = {}) {
 ...
 */
export async function animateOutAndRemove(element, preset = 'fadeOut', config) {
 ...
 */
export function transition(element, property, toValue, durationMs = 250) {
    return new Promise((resolve) => {
