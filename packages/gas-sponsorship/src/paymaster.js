 ...
 */
async function pimlicoGetPaymasterData(url, userOperation, chainId) {
    const result = await rpcCall(url, "pm_getPaymasterStubData", [
        {
 ...
 */
async function alchemyGetPaymasterData(url, userOperation, chainId) {
    const result = await rpcCall(url, "alchemy_requestGasAndPaymasterAndData", [
        {
            policyId: "default",
 ...
 */
async function candleGetPaymasterData(url, userOperation, chainId) {
 ...
 */
export async function getPaymasterData(userOperation, paymasterUrl, chainId) {
 ...
 */
export async function getPaymasterAndData(userOperation, paymasterUrl, chainId) {
    const { paymasterAndData } = await getPaymasterData(userOperation, paymasterUrl, chainId);
