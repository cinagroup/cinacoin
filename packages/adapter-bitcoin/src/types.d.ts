 ...
 */
export type BitcoinFeature = 'bitcoin:connect' | 'bitcoin:signMessage' | 'bitcoin:signTransaction' | 'bitcoin:signPsbt' | 'bitcoin:sendTransfer' | 'bitcoin:sendBitcoin' | 'bitcoin:switchNetwork' | 'bitcoin:ordinals' | 'bitcoin:brc20' | 'bitcoin:runes';
/**
