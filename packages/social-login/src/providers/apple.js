...
export async function generateAppleClientSecret(params) {
    ...
    //     .sign(key);
    throw new Error('Apple client_secret generation requires the jose library. ' +
 ...
 */
export async function exchangeAppleCode(code, params, clientSecret) {
 ...
 */
export async function loginWithApple(code, params, deriveWallet, appleUserData) {
