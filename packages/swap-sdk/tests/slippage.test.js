...
import { calculateMinimumReceived, calculatePriceImpact, classifyPriceImpact, getImpactWarning, isPriceImpactAcceptable, getExchangeRate, percentDiff, adjustSlippageForVolatility, } from '../src/slippage.js';
describe('calculateMinimumReceived', () => {
    it('should calculate minimum received with 0% slippage', () => {
        const result = calculateMinimumReceived(1000000n, 0);
        expect(result).toBe(1000000n);
    });
    it('should calculate minimum received with 1% slippage (100 bps)', () => {
        const result = calculateMinimumReceived(1000000n, 100);
    ...
    it('should calculate minimum received with 0.5% slippage (50 bps)', () => {
        const result = calculateMinimumReceived(2000000n, 50);
        // 2_000_000 * 0.995 = 1_990_000
        expect(result).toBe(1990000n);
    });
    ...
    it('should calculate minimum received with 100% slippage (10000 bps)', () => {
        const result = calculateMinimumReceived(1000000n, 10000);
        expect(result).toBe(0n);
    });
    it('should throw for negative slippage', () => {
        expect(() => calculateMinimumReceived(1000000n, -1)).toThrow('slippageBps must be between 0 and 10,000');
    });
    it('should throw for slippage over 10000 bps', () => {
        expect(() => calculateMinimumReceived(1000000n, 10001)).toThrow('slippageBps must be between 0 and 10,000');
    });
...
describe('isPriceImpactAcceptable', () => {
    function makeQuote(priceImpact) {
        return {
            id: 'test',
            fromToken: '0xUSDC',
            toToken: '0xWETH',
...
describe('getExchangeRate', () => {
    ...
    it('should handle large numbers', () => {
        ...
        const usdc = 3000000000n; // 3000 * 10^6
...
//# sourceMappingURL=slippage.test.js.map