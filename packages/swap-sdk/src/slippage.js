 ...
 */
export function calculateMinimumReceived(toAmount, slippageBps) {
 ...
 */
export function calculatePriceImpact(fromAmount, toAmount, midPrice) {
    if (fromAmount === 0n) {
        return {
            percentage: 0,
            severity: "low",
 ...
 */
export function classifyPriceImpact(impactPercentage) {
 ...
 */
export function getImpactWarning(impactPercentage) {
    if (impactPercentage >= 5) {
 ...
 */
export function isPriceImpactAcceptable(quote, maxImpactBps) {
 ...
 */
export function getExchangeRate(fromAmount, toAmount) {
    if (fromAmount === 0n)
        return 0;
 ...
 */
export function adjustSlippageForVolatility(baseSlippageBps, volatilityScore) {
