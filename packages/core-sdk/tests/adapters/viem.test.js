...
class MockViemClient {
    constructor(accounts = ['0xMockAccount1'], chainId = 1) {
        this.account = { address: `0xMockAccount1` };
        this.chain = { id: 1, name: 'Ethereum', rpcUrls: { default: { http: ['https://eth.rpc'] } } };
        this.transport = {
            value: {
...
//# sourceMappingURL=viem.test.js.map