...
import { WagmiConnector, MultiChainConnector, createWagmiConnector, createMultiChainConnector, } from '../../src/adapters/wagmi.js';
function createMockWagmiConnector(overrides) {
    return {
        id: 'injected',
...
function makeTransport() {
    return {
        value: {
            request: async ({ method }) => method === 'personal_sign' ? '0xsignature' : '0xresult',
        },
    };
}
function createMockWagmiConfig() {
    return {
        chains: [
...
//# sourceMappingURL=wagmi.test.js.map