...
function createMockProvider(overrides) {
    ...
    const network = { chainId, name: 'homestead' };
    const signer = {
        getAddress: async () => accounts[0],
        getBalance: async () => mockBigInt(1000),
        signMessage: async (msg) => `0xethers6sig_${typeof msg === 'string' ? msg.slice(0, 10) : 'bytes'}`,
...
//# sourceMappingURL=ethers6.test.js.map