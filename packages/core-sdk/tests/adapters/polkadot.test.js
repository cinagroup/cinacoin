...
import { PolkadotChainAdapter, POLKADOT_CHAINS, POLKADOT_WALLETS, decodeSS58, isValidSS58Address, } from '../../src/adapters/polkadot.js';
/* ------------------------------------------------------------------ */
...
describe('isValidSS58Address', () => {
    ...
    it('rejects non-string inputs', () => {
        expect(isValidSS58Address(123)).toBe(false);
    });
});
describe('decodeSS58', () => {
...
describe('PolkadotChainAdapter buildTransfer', () => {
    ...
    it('builds a valid DOT transfer', () => {
        const tx = adapter.buildTransfer('13KjEoTnVdVrZJzKjLzN1KjEoTnVdVrZJzKjLzN1KjEoTnVd', '10000000000');
    ...
    it('throws on invalid recipient', () => {
        expect(() => adapter.buildTransfer('invalid-address', '10000000000')).toThrow('Invalid recipient address');
    });
});
describe('PolkadotChainAdapter buildAssetTransfer', () => {
    ...
    it('throws on invalid recipient', () => {
        expect(() => adapter.buildAssetTransfer({
            assetId: '1984',
            to: 'invalid',
            amount: '100',
...
describe('PolkadotChainAdapter sendTransaction', () => {
    ...
    it('throws when no provider', async () => {
        await expect(adapter.sendTransaction({ to: '13KjEoTnVdVrZJzKjLzN1KjEoTnVdVrZJzKjLzN1KjEoTnVd', value: '1000' })).rejects.toThrow('No provider connected');
    });
});
/* ------------------------------------------------------------------ */
/*  signMessage                                                        */
...
//# sourceMappingURL=polkadot.test.js.map