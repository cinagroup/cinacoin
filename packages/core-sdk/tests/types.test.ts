/**
 * Core type validation tests for the OnChainUX SDK.
 *
...
describe('ChainNamespace type', () => {
  ...
  it('ChainNamespace is a union of known values', () => {
    ...
    const _eip155: ChainNamespace = 'eip155';
    const _solana: ChainNamespace = 'solana';
    const _ton: ChainNamespace = 'ton';
