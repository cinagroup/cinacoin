...
import { generateWalletConnectUniversalLink } from './universal-link.js';
/**
 ...
 */
export function smartRedirect(params, options) {
    return new Promise((resolve, reject) => {
        ...
        if (platform === 'web') {
            const universalUrl = generateWalletConnectUniversalLink(params.walletId, params.uri, getAppStoreFallback(params.walletId));
            tryResolve({
                success: true,
