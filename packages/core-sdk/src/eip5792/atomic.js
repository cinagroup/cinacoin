 ...
 */
export function supportsAtomicBatch(chainId) {
 ...
 */
export function buildAtomicBatch(config) {
 ...
 */
export async function executeAtomicBatch(client, config) {
 ...
 */
export function createEthTransferCall(to, amountWei) {
    return {
        to,
 ...
 */
export function createContractCall(to, data, value) {
    return {
        to,
        data,
 ...
 */
export function createErc20ApproveCall(tokenAddress, spender, amount) {
 ...
 */
export function createApproveAndSwapCalls(tokenAddress, spender, amount, swapCalls) {
