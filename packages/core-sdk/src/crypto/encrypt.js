 ...
 */
export function encrypt(key, plaintext, nonce) {
 ...
 */
export function decrypt(key, encryptedBase64) {
 ...
 */
export function deriveSymmetricKey(publicKeyA, publicKeyB) {
 ...
 */
export function deriveTopic(publicKeyA, publicKeyB) {
