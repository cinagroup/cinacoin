...
vi.mock('../src/walletRegistry', () => ({
    ...
    buildWalletDeepLink: vi.fn((walletId, wcUri) => {
        const wallet = {
    ...
    buildWalletUniversalLink: vi.fn((walletId, wcUri) => {
        const wallet = {
...
describe('Deep Links', () => {
    ...
    describe('getWalletById', () => {
        it('should find MetaMask by ID', () => {
            const { getWalletById } = require('../src/walletRegistry');
...
//# sourceMappingURL=deepLinks.test.js.map