...
// ============================================================
// Tests for @onchainux/react-native ConnectModal
// ============================================================
...
vi.mock('../src/OnChainUXProvider', () => ({
  useOnChainUXContext: vi.fn(() => ({
...
vi.mock('@onchainux/walletconnect-v2', () => ({
  WALLET_REGISTRY: [
    {
      id: 'metamask',
      name: 'MetaMask',
...
describe('ConnectModal', () => {
  ...
  describe('deep linking', () => {
    it('should build deep link with WC URI', () => {
      const { buildWalletDeepLink } = require('@onchainux/walletconnect-v2');
    ...
    it('should build universal link as fallback', () => {
      const { buildWalletUniversalLink } = require('@onchainux/walletconnect-v2');
      const uri = 'wc:test@2?relay-protocol=irn&symKey=test';
  ...
  describe('wallet selection', () => {
    it('should call onClose after successful connection', async () => {
      const onClose = vi.fn();
      const { useOnChainUXContext } = require('../src/OnChainUXProvider');
      const { connect } = useOnChainUXContext();
