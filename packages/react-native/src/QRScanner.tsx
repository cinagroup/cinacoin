...
export function QRScanner({
  ...
  const { connectWithUri, connect, themeColors, wcUri } = useOnChainUXContext();
  ...
  const handleSimulatedScan = useCallback(() => {
    ...
    const testUri =
      wcUri ??
      'wc:7f4b7e3c-1a2b-4c5d-8e9f-0a1b2c3d4e5f@2?relay-protocol=waku&relay-url=wss%3A%2F%2Frelay.onchainux.io%2Fv1&symKey=abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890';
