 ...
 */
export function buildLoginResult(provider) {
 ...
 */
export function telegramIdToAddress(telegramId) {
 ...
 */
export function generateSignInMessage(user, domain, nonce) {
 ...
 */
export function isInitDataExpired(initData, maxAgeMs = 24 * 60 * 60 * 1000) {
    const params = new URLSearchParams(initData);
