...
import { WC_METHODS, WC_EVENTS, SOLANA_METHODS, SOLANA_EVENTS, getDefaultRequiredNamespaces, buildSendTransaction, buildPersonalSign, buildSignTypedDataV4, buildEthSign, buildSignTransaction, buildSwitchChain, buildAddChain, buildWatchAsset, buildScanQRCode, buildSolanaSignMessage, buildSolanaSignTransaction, isEvmMethod, isSolanaMethod, isWcInternalMethod, getMethodDescription, METHOD_REGISTRY, } from '../src/methods.js';
// ============================================================
// Constants
// ============================================================
describe('WC_METHODS', () => {
