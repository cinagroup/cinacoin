 ...
 */
import { generateSymKey, generateTopic, hexToBytes, encrypt, decrypt } from './crypto.js';
 ...
 */
export function parseWcUri(uri) {
    // Remove "wc:" prefix
 ...
 */
export function formatWcUri(params) {
 ...
 */
export async function createPairing(config) {
 ...
 */
export async function approvePairing(uri, config) {
 ...
 */
export async function rejectPairing(relay, topic, symKey, reason = 'User rejected') {
 ...
 */
export async function deletePairing(relay, topic, symKey, code = 6000, message = 'User disconnected') {
 ...
 */
async function sendPairingDelete(relay, topic, symKey, code, message) {
    const notification = {
        jsonrpc: '2.0',
 ...
 */
export async function pairingPing(relay, topic, symKey, timeoutMs = 5000) {
 ...
 */
export function encryptPairingMessage(symKey, payload) {
 ...
 */
export function decryptPairingMessage(symKey, encrypted) {
    const key = hexToBytes(symKey);
 ...
 */
export function isValidWcUri(uri) {
    try {
        const parsed = parseWcUri(uri);
 ...
 */
export function isPairingExpired(pairing) {
 ...
 */
export function isPairingValid(pairing) {
