 ...
 * ```
 */
export class BladeWalletConnector {
    constructor() {
        this.id = 'blade';
        this.name = 'Blade Wallet';
        this.icon = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect width="32" height="32" rx="4" fill="%232563EB"/><text x="16" y="22" text-anchor="middle" font-size="14" fill="white" font-family="sans-serif" font-weight="bold">B</text></svg>';
    ...
    _getProviderOrThrow() {
        this._captureProvider();
        if (!this._provider) {
            throw new Error('Blade Wallet not found. Install the Blade Wallet extension: https://blade_wallet.io/');
        }
 ...
 */
export function announceBladeEIP6963() {
    if (typeof window === 'undefined')
        return;
    const win = window;
    if (!win.blade)
...
//# sourceMappingURL=blade-wallet.js.map