 ...
 */
export function createSiweMessage(user, params) {
 ...
 */
export function verifySignature(_message, _signature, _address) {
...
export class FarcasterAuth {
     ...
     */
    static createSignInMessage(user, params) {
     ...
     */
    static buildResult(user, params) {
     ...
     */
    static getVerifiedAddress(user) {
...
//# sourceMappingURL=FarcasterAuth.js.map