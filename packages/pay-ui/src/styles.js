 ...
 */
export function getWidgetStyles(theme = "light", customPrimary) {
    const c = theme === "dark"
        ? {
 ...
 */
export function buttonStyles(variant = "primary", size = "md", disabled = false) {
    const sizeMap = {
 ...
 */
export function inputStyles(focus = false) {
    return {
        width: "100%",
