...
// Wallet connectors
export { NearCinacoinor } from './connectors/near-wallet.js';
export { HereCinacoinor } from './connectors/here-wallet.js';
...
export {
  ...
  type NearCinacoinor as NearCinacoinorInterface,
