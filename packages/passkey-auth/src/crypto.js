 ...
 */
export function decodeChallenge(challengeBase64) {
 ...
 */
export function signData(privateKeyHex, data) {
 ...
 */
export function verifySignature(publicKeyHex, data, signatureHex) {
    try {
 ...
 */
export function compressPublicKey(publicKeyHex) {
    const publicKey = hexToBytes(publicKeyHex);
