 ...
 * @returns icon URL
 */
export function fetchWalletLogo(walletId, size = DEFAULT_SIZE) {
 ...
 * @returns icon URL
 */
export function fetchChainLogo(chainId) {
 ...
 */
export function preloadLogos(walletIds) {
    walletIds.forEach(id => fetchWalletLogo(id));
}
//# sourceMappingURL=logoFetcher.js.map