 ...
 * ```svelte
 * <script lang="ts">
 *   import { getCinaConnect } from '@cinaconnect/svelte';
 *   const { open, close, isOpen } = getCinaConnect();
 * </script>
 *
 ...
 */
export declare function getCinaConnect(): {
 ...
 * ```svelte
 * <script lang="ts">
 *   import { getCinaConnectAccount } from '@cinaconnect/svelte';
 *   const account = getCinaConnectAccount();
 * </script>
 *
 ...
 */
export declare function getCinaConnectAccount(): {
 ...
 * ```svelte
 * <script lang="ts">
 *   import { getCinaConnectNetwork } from '@cinaconnect/svelte';
 *   const network = getCinaConnectNetwork();
 * </script>
 *
 ...
 */
export declare function getCinaConnectNetwork(): {
...
//# sourceMappingURL=useCinaConnect.d.ts.map