...
import { CinaConnectCore } from '@cinaconnect/core-sdk';
import { CinaConnectService } from './cinaconnect.service.js';
import { CINA_CONNECT_OPTIONS, CINA_CONNECT_INSTANCE, } from './cinaconnect.tokens.js';
// Components
...
let CinaConnectModule = (() => {
    ...
    let _classThis;
    var CinaConnectModule = _classThis = class {
        /**
    ...
    __setFunctionName(_classThis, "CinaConnectModule");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        CinaConnectModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CinaConnectModule = _classThis;
})();
export { CinaConnectModule };
//# sourceMappingURL=cinaconnect.module.js.map