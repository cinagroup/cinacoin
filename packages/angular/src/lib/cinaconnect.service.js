...
/**
 * Injectable Angular service for interacting with CinaConnect Core SDK.
 *
 * Provides reactive state via RxJS Observables and imperative wallet operations.
 *
 * ```ts
 * constructor(private cina: CinaConnectService) {}
 *
 * ngOnInit() {
 ...
 * ```
 */
let CinaConnectService = (() => {
    let _classDecorators = [Injectable({ providedIn: 'root' })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var CinaConnectService = _classThis = class {
        ...
        // -- Modal Control ---------------------------------------------------------
        /**
         * Open the CinaConnect connection modal.
         *
        ...
        /**
         * Close the CinaConnect connection modal.
         */
        close() {
            this._open$.next(false);
        }
        ...
        connect(connectorId) {
            if (!this.connector) {
                return Promise.reject(new Error('CinaConnect connector not initialized'));
            }
            this._open$.next(true);
    ...
    __setFunctionName(_classThis, "CinaConnectService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        CinaConnectService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CinaConnectService = _classThis;
})();
export { CinaConnectService };
//# sourceMappingURL=cinaconnect.service.js.map