...
import { Connector, TransactionRequest } from '@cinaconnect/core-sdk';
 ...
 * ```
 */
export declare class CinaConnectService implements OnDestroy {
    private options;
    private connector;
    private _account$;
    private _network$;
    ...
    constructor(options: CinaConnectAngularConfig, connector: Connector);
...
//# sourceMappingURL=cinaconnect.service.d.ts.map