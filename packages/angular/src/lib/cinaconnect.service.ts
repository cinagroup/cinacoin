...
import { Connector, Chain, TransactionRequest } from '@cinaconnect/core-sdk';
import {
...
export class CinaConnectService implements OnDestroy {
  ...
  constructor(
    @Inject(CINA_CONNECT_OPTIONS) private options: CinaConnectAngularConfig,
