/**
 * Type definitions for @onchainux/vue
 */
...
/** Context value provided by OnChainUXProvider. */
export interface OnChainUXContext {
...
/** Injection key for OnChainUX context. */
export const ONCHAINUX_KEY = Symbol('onchainux');
