...
> `@onchainux/onramp-sdk` — Multi-provider fiat-to-crypto gateway aggregator.
...
```typescript
import { OnRampWidget } from '@onchainux/onramp-sdk'
...
```typescript
import { MoonPayProvider } from '@onchainux/onramp-sdk'
...
```typescript
import { RampProvider } from '@onchainux/onramp-sdk'
...
```typescript
import { TransakProvider } from '@onchainux/onramp-sdk'
