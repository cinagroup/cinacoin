...
> `@onchainux/swap-sdk` — Multi-DEX swap routing with slippage protection.
...
```bash
npm install @onchainux/swap-sdk
```
...
```typescript
import { SwapQuoter } from '@onchainux/swap-sdk'
...
```typescript
import { SwapRouter } from '@onchainux/swap-sdk'
...
```typescript
import { UniswapExecutor } from '@onchainux/swap-sdk'
...
```typescript
import { OneInchExecutor } from '@onchainux/swap-sdk'
...
```typescript
import { ZeroxExecutor } from '@onchainux/swap-sdk'
