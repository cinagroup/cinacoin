...
> `@onchainux/session-keys` — Temporary signing keys with policies and social recovery for ERC-4337 smart accounts.
...
```bash
npm install @onchainux/session-keys
```
...
```typescript
import { SessionKeyPolicyManager } from '@onchainux/session-keys'
...
```typescript
import { SocialRecoveryManager } from '@onchainux/session-keys'
...
```typescript
import { encodeEnableSessionKey } from '@onchainux/session-keys'
...
```typescript
import { encodeDisableSessionKey } from '@onchainux/session-keys'
...
```typescript
import { isKeyValidForOperation } from '@onchainux/session-keys'
