...
```typescript
// 生成 X25519 密钥对
import { generateKeyPair } from '@onchainux/core/crypto'

const keyPair = generateKeyPair()
// { publicKey: '0x...', privateKey: '0x...' }

// 生成共享密钥 (ECDH)
import { deriveSharedSecret } from '@onchainux/core/crypto'
...
// 加密消息
import { encrypt, decrypt } from '@onchainux/core/crypto'
...
- 安全团队: `security@onchainux.com`
- 紧急通道: `#onchainux-security` (内部)
