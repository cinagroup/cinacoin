...
await testPage('Cloud Dashboard /projects', 'https://cloud.cinacoin.com/projects', { cssVars: true });
await testPage('Cloud Dashboard /api-keys', 'https://cloud.cinacoin.com/api-keys', { cssVars: true });
await testPage('Cloud Dashboard /billing', 'https://cloud.cinacoin.com/billing', { cssVars: true });
await testPage('Cloud Dashboard /settings', 'https://cloud.cinacoin.com/settings', { cssVars: true });
