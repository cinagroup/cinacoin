...
|------|------|---------|-------------|
| `memory-tdai/persona.md` | `user` | - | 用户叙事档案 - 核心原型、偏好、交互协议 |
| `memory-tdai/scene_blocks/` | `various` | - | 场景记忆（带热度评分） |

### Project Context (项目上下文)
| File | Type | Updated | Description |
|------|------|---------|-------------|
| `memory/incident-*.md` | `feedback` | - | 事件复盘与教训 |
| `memory/longterm/` | `project` | - | 长期项目记忆归档 |
...
*Memory System v3.0 - Powered by OpenClaw Memory System Skill*
