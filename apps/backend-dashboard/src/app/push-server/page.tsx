  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <MetricBox label="Device Tokens" value={formatNumber(metrics.deviceTokens || 0)} color="text-emerald-400" trend="up" />
            ...
            <tbody>
              {TOPICS.map((t, i) => (
                <tr key={i} className="border-b border-dashboard-border/30 hover:bg-dashboard-border/20">
                  <td className="px-5 py-3 font-mono text-xs text-white">{t.name}</td>
                  <td className="px-5 py-3 text-white">{formatNumber(t.subscribers)}</td>
