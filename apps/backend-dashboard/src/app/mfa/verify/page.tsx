          ...
          {!useRecovery ? (
            <>
              ...
              {isLoading && (
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <span className="text-body-sm text-[var(--cc-link)]">Verifying…</span>
                </div>
              )}
              ...
              <button
                ...
                className="w-full text-body-sm text-[var(--cc-link)] hover:underline text-center"
              >
            ...
            <>
              ...
              <button
                ...
                className="w-full text-body-sm text-[var(--cc-link)] hover:underline text-center mt-4"
              >
