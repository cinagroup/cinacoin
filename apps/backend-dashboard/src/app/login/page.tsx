      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[var(--cc-canvas)] border border-[var(--cc-hairline)] rounded-[var(--cc-radius-md)] p-6 shadow-[var(--cc-level3)]">
            ...
            <>
              <div className="space-y-3 mb-6">
                {oauthProviders.map((provider) => (
                  ...
                  >
                    <span className="text-body-lg">{provider.icon}</span>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-body-sm font-medium text-[var(--cc-ink)] mb-1">
                Email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="block text-body-sm font-medium text-[var(--cc-ink)] mb-1">
                Password
              </label>
              <input
                id="password"
          ...
          {/* Info */}
          <div className="mt-6 space-y-2 text-caption text-[var(--cc-body)]">
            <p className="flex items-start gap-2">
              <svg className="w-4 h-4 flex-shrink-0 mt-1 text-[var(--cc-muted)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="text-center mt-6">
          <Link
            ...
            className="text-body-sm text-[var(--cc-body)] hover:text-[var(--cc-ink)] transition-colors"
          >
