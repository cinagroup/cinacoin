    ...
    <div className="min-h-screen bg-[var(--cc-canvas-soft)] text-[var(--cc-ink)] flex flex-col">
      ...
      <main id="main-content" className="flex-1 flex flex-col items-center justify-center px-4 text-center">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          ...
          <Link
            href="/swap"
            className="px-6 py-4 rounded-[6px] font-[500] text-body-md leading-[24px] bg-[var(--cc-canvas-soft-2)]/60 border border-[var(--cc-hairline-strong)]/60 text-[var(--cc-body)] hover:text-[var(--cc-ink)] hover:border-[var(--cc-hairline-strong)] transition-all duration-200"
          >
            Try Swap Demo →
          </Link>
        </div>
