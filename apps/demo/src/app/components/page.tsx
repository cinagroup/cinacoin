  ...
  return (
    <div className="relative rounded-md overflow-hidden border border-[var(--cc-hairline-strong)]/40">
      <div className="flex items-center justify-between px-4 py-2 bg-[var(--cc-canvas)]/60 border-b border-[var(--cc-hairline-strong)]/40">
        <span className="text-caption text-[var(--cc-body)] font-[var(--font-mono)]">{lang}</span>
        <button
          onClick={handleCopy}
          className={`text-caption px-2 py-1 rounded transition-all ${
      ...
      <pre className="p-4 text-caption text-[var(--cc-body)] font-[var(--font-mono)] overflow-x-auto bg-[var(--cc-canvas)]/50 leading-relaxed">
        {code}
      </pre>
    </div>
  );
  ...
  return (
    <div className={`${theme.card} backdrop-blur-xl rounded-[var(--cc-radius-md)] border ${theme.border} overflow-hidden`}>
      <div className="px-5 py-4 border-b border-[var(--cc-hairline-strong)]/30 flex items-center justify-between">
        <div>
          <h3 className={`text-body-lg font-semibold tracking-tight ${theme.text}`}>{title}</h3>
          <p className="text-caption text-[var(--cc-body)] mt-1">{description}</p>
        </div>
        <button
          onClick={() => setShowCode(!showCode)}
          className={`text-caption px-3 py-2 rounded-lg transition-all ${
            showCode
    ...
    <DemoLayout>
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-2">
          <p className="font-mono text-caption text-[var(--cc-muted)] mb-2">03</p>
        ...
        <ComponentShowcase
          ...
          preview={
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3 items-center">
                ...
                <button className="px-5 py-3 rounded-md font-semibold text-body-sm text-[var(--cc-primary)] hover:text-[var(--cc-ink)] transition-colors">
                  Ghost
                </button>
                <button className="px-5 py-3 rounded-md font-semibold text-body-sm bg-[var(--cc-error)]/15 text-[var(--cc-error)] border border-[var(--cc-error)]/25 hover:bg-[var(--cc-error)]/25 transition-all">
                  Danger
                </button>
                <button className="px-5 py-3 rounded-md font-semibold text-body-sm bg-[var(--cc-success)]/15 text-[var(--cc-success)] border border-[var(--cc-success)]/25 hover:bg-[var(--cc-success)]/25 transition-all">
                  Success
                </button>
                <button disabled className="px-5 py-3 rounded-md font-semibold text-body-sm bg-[var(--cc-canvas-soft-2)]/40 text-[var(--cc-body)] cursor-not-allowed">
                  Disabled
                </button>
              </div>
          ...
          code={`// Primary Button
<button className="px-5 py-3 rounded-md font-semibold text-body-sm
...
// Sizes: text-caption/rounded-lg (sm), text-body-sm/rounded-md (md), text-body-md/rounded-[var(--cc-radius-md)] (lg)`}
        />
            ...
            <div className="space-y-3">
              {isConnected ? (
                <div className="flex items-center gap-4 p-4 rounded-md bg-[var(--cc-canvas)]/60 border border-[var(--cc-hairline-strong)]/40">
                  <div className="size-12 rounded-full bg-gradient-to-br from-[var(--cc-link)]/80 to-[var(--cc-link)] flex items-center justify-center text-body-sm font-semibold tracking-tight text-[var(--cc-ink)] shadow-[var(--cc-level3)]">
                    {account.address?.slice(2, 4).toUpperCase()}
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-body-sm font-[var(--font-mono)] text-[var(--cc-body)] truncate">{shortenAddress(account.address ?? '')}</p>
                    <p className="text-caption text-[var(--cc-body)]">{account.chainName} · Chain ID: {account.chainId}</p>
                  </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-md bg-[var(--cc-canvas)]/60 border border-[var(--cc-hairline-strong)]/40">
                  <div className="size-12 rounded-full bg-gradient-to-br from-[var(--cc-link)]/80 to-[var(--cc-link)] flex items-center justify-center text-body-sm font-semibold tracking-tight text-[var(--cc-ink)]">
                    00
                  </div>
                  <div className="flex-1">
                    <p className="text-body-sm font-[var(--font-mono)] text-[var(--cc-body)]">0x1a2b...3c4d</p>
                    <p className="text-caption text-[var(--cc-body)]">Ethereum · Chain ID: 1</p>
                  </div>
                  <div className="text-right">
                    <p className="text-body-sm font-semibold text-[var(--cc-body)]">1.2345 ETH</p>
                  </div>
                </div>
              )}
            </div>
...
<div className="flex items-center gap-4 p-4 rounded-md
  ...
  <div className="size-12 rounded-full bg-gradient-to-br
    ...
    text-body-sm font-semibold tracking-tight text-[var(--cc-ink)]">
    {address.slice(2, 4).toUpperCase()}
  </div>

  {/* Info */}
  <div className="flex-1 min-w-0">
    <p className="text-body-sm font-[var(--font-mono)] truncate">
  ...
  {/* Balance */}
  <div className="text-right">
    <p className="text-body-sm font-semibold">{balance} {symbol}</p>
  </div>
</div>`}
        />
          ...
          preview={
            <div className="space-y-4">
              <div className="flex flex-wrap gap-3">
                {/* Connection status */}
                <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-caption font-semibold bg-[var(--cc-success)]/15 text-[var(--cc-success)] border border-[var(--cc-success)]/25">
                  <span className="size-3 rounded-full bg-[var(--cc-success)] animate-pulse" />
                  Connected
                </span>
                <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-caption font-semibold bg-[var(--cc-warning)]/15 text-[var(--cc-warning)] border border-[var(--color-warning)]/25">
                  <span className="size-3 rounded-full bg-[var(--cc-warning)] animate-pulse" />
                  Connecting...
                </span>
                <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-caption font-semibold bg-[var(--cc-canvas-soft-2)]/50 text-[var(--cc-body)] border border-[var(--cc-hairline-strong)]/40">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-caption font-semibold bg-[var(--cc-warning)]/15 text-[var(--cc-warning)] border border-[var(--cc-warning)]/25">
                  <span className="size-3 rounded-full bg-[var(--cc-warning)] animate-pulse" />
                  Pending
                </span>
                <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-caption font-semibold bg-[var(--cc-error)]/15 text-[var(--cc-error)] border border-[var(--cc-error)]/25">
                  ✗ Failed
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full text-caption font-[var(--font-mono)] bg-[var(--cc-link)]/15 text-[var(--cc-link)] border border-[var(--cc-link)]/25">
                  142ms
                </span>
              </div>
            </div>
...
<span className="inline-flex items-center gap-2 px-3 py-2
  rounded-full text-caption font-semibold
...
// Latency Badge
<span className="inline-flex items-center gap-2 px-3 py-2
  rounded-full text-caption font-[var(--font-mono)]
          ...
          preview={
            <div className="flex flex-wrap gap-2">
              {[
                ...
                >
                  <span
                    className="inline-flex size-6 items-center justify-center rounded-full text-caption font-semibold tracking-tight text-[var(--cc-ink)]"
                    style={{ backgroundColor: c.color }}
                  >
                    {c.initial}
                  </span>
                  <span className="text-caption font-medium text-[var(--cc-muted)] group-hover:text-[var(--cc-body)] transition-colors">
                    {c.name}
                  </span>
                </div>
              ))}
...
<div className="flex items-center gap-2 px-3 py-2 rounded-md
  ...
  <span className="inline-flex size-6 items-center justify-center
    rounded-full text-caption font-semibold tracking-tight text-[var(--cc-ink)]"
    style={{ backgroundColor: chainColor }}>
    {chain.initial}
  </span>
  <span className="text-caption font-medium text-[var(--cc-muted)]
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="0x..."
                  className="w-full px-4 py-3 bg-[var(--cc-canvas)]/60 border border-[var(--cc-hairline-strong)]/50 rounded-md text-body-sm text-[var(--cc-body)] placeholder:text-[var(--cc-body)] focus:outline-none focus:ring-2 focus:ring-[var(--cc-link)]/40 focus:border-[var(--cc-primary)]/50 font-[var(--font-mono)]"
                  readOnly
              ...
              <div className="relative">
                ...
                <span className="pointer-events-none absolute right-3 top-9 text-[var(--cc-body)] text-caption">▾</span>
              </div>
            </div>
          }
          code={`// Text Input
<input
  ...
  className="w-full px-4 py-3 bg-[var(--cc-canvas)]/60 border
    border-[var(--cc-hairline-strong)]/50 rounded-md text-body-sm text-[var(--cc-body)]
...
<select className="w-full px-4 py-3 bg-[var(--cc-canvas)]/60 border
  border-[var(--cc-hairline-strong)]/50 rounded-md text-body-sm appearance-none
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <div key={s.label} className="text-center p-3 rounded-md bg-[var(--cc-canvas)]/50 border border-[var(--cc-hairline)]/50">
                    <div className="text-display-sm font-semibold tracking-tight from-[var(--cc-link)]/80 to-[var(--cc-link)]/60 bg-clip-text text-transparent">
                      {s.value}
                    </div>
...
<div className="group p-4 rounded-md bg-[var(--cc-canvas)]/50 border
  ...
  <div className="text-display-md mb-2">{icon}</div>
  <h4 className="text-body-sm font-semibold text-[var(--cc-body)]">{title}</h4>
  <p className="text-caption text-[var(--cc-body)] mt-1">{description}</p>
</div>
...
<div className="text-center p-3 rounded-md bg-[var(--cc-canvas)]/50
  ...
  <div className="text-display-sm font-semibold tracking-tight bg-gradient-to-r
    from-[var(--cc-link)]/80 to-[var(--cc-link)]/60 bg-clip-text text-transparent">
    {value}
  </div>
  <div className="text-caption text-[var(--cc-body)] mt-1">{label}</div>
</div>`}
        />
          ...
          preview={
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-6 items-center">
                ...
                <span className="inline-flex items-center gap-2 text-body-sm text-[var(--cc-muted)]">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={t.type} className={`p-3 rounded-md ${t.bg} border ${t.border} flex items-start gap-3`}>
                  ...
                  <div>
                    <p className={`text-body-sm font-semibold ${t.text}`}>{t.type}</p>
                    <p className="text-caption text-[var(--cc-muted)] mt-1">{t.desc}</p>
                  </div>
                </div>
              ))}
            </div>
...
function ToggleDemo({ label, desc, defaultChecked }: { label: string; desc: string; defaultChecked: boolean }) {
  ...
  return (
    <div className="flex items-center justify-between p-3 rounded-md bg-[var(--cc-canvas)]/40 border border-[var(--cc-hairline)]/40">
      <div>
        <p className="text-body-sm font-medium text-[var(--cc-body)]">{label}</p>
        <p className="text-caption text-[var(--cc-body)]">{desc}</p>
      </div>
      <button
