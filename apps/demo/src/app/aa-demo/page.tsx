      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="flex items-center justify-between bg-[var(--cc-canvas-soft-2)]/40 backdrop-blur rounded-[var(--cc-radius-md)] border border-[var(--cc-hairline-strong)]/50 px-5 py-4">
          {isConnected ? (
            <div className="flex items-center gap-3">
              <div className="size-8 rounded-full bg-gradient-to-br from-[var(--cc-violet)] to-[var(--cc-violet-deep)] flex items-center justify-center text-caption font-semibold tracking-tighter text-[var(--cc-ink)]">
                {account.address?.slice(2, 4).toUpperCase()}
              </div>
              <div>
                <p className="text-body-sm font-[var(--font-mono)] text-[var(--cc-body)]">{shortenAddress(account.address ?? '')}</p>
                <p className="text-caption text-[var(--cc-body)]">{account.chainName}</p>
              </div>
            </div>
          ) : (
            <button
          ...
          {isConnected && (
            <button
              onClick={() => disconnect()}
              className="px-4 py-2 rounded-md text-caption font-semibold bg-[var(--cc-canvas-soft-2)]/60 text-[var(--cc-body)] border border-[var(--cc-hairline-strong)]/40 hover:text-[var(--cc-ink)] transition-all"
            >
              Disconnect
            </button>
          )}
        ...
        <div className="bg-[var(--cc-canvas-soft-2)]/60 backdrop-blur-xl rounded-[var(--cc-radius-md)] border border-[var(--cc-hairline-strong)]/60 overflow-hidden">
          <div className="px-5 py-4 border-b border-[var(--cc-hairline-strong)]/50 flex items-center justify-between">
            <div>
              <h2 className="text-body-lg font-semibold tracking-tighter text-[var(--cc-ink)]">🏦 Smart Account</h2>
              <p className="text-caption text-[var(--cc-body)] mt-1">ERC-4337 Account Abstraction wallet</p>
            </div>
          ...
          <div className="p-5 space-y-4">
            {!isConnected && (
              <div className="text-center py-6 text-body-sm text-[var(--cc-body)]">
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  {[
                    ...
                    <div key={s.step} className="text-center p-3 rounded-md bg-[var(--cc-canvas)]/40 border border-[var(--cc-hairline)]/40">
                      ...
                      <p className="text-caption text-[var(--cc-body)] mt-1">{s.desc}</p>
                    </div>
                  ))}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-md bg-[var(--cc-canvas)]/40 border border-[var(--cc-hairline)]/40">
                    <p className="text-caption text-[var(--cc-body)]">Owner</p>
                    <p className="text-caption font-[var(--font-mono)] text-[var(--cc-body)] mt-1">{shortenAddress(account.address ?? '')}</p>
                  </div>
                  <div className="p-3 rounded-md bg-[var(--cc-canvas)]/40 border border-[var(--cc-hairline)]/40">
                    <p className="text-caption text-[var(--cc-body)]">ERC-4337</p>
                    <p className="text-caption text-[var(--cc-success)] mt-1 font-semibold">Supported ✓</p>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="bg-[var(--cc-canvas-soft-2)]/60 backdrop-blur-xl rounded-[var(--cc-radius-md)] border border-[var(--cc-hairline-strong)]/60 overflow-hidden">
          <div className="px-5 py-4 border-b border-[var(--cc-hairline-strong)]/50 flex items-center justify-between">
            <div>
              <h2 className="text-body-lg font-semibold tracking-tighter text-[var(--cc-ink)]">🔑 Session Keys</h2>
              <p className="text-caption text-[var(--cc-body)] mt-1">Temporary keys with limited permissions</p>
            </div>
            <button
              ...
              <div className="p-4 rounded-md bg-[var(--cc-canvas)]/50 border border-[var(--cc-hairline-strong)]/40 space-y-3">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-[var(--cc-canvas-soft-2)]/80 border border-[var(--cc-hairline-strong)]/50 rounded-lg text-body-sm text-[var(--cc-body)] placeholder:text-[var(--cc-body)] focus:outline-none focus:ring-2 focus:ring-violet-500/40"
                  />
                  <button
                ...
                <div className="flex gap-2">
                  {['swap', 'approve', 'mint', 'transfer'].map((p) => (
                    <span key={p} className="px-2 py-1 rounded text-caption font-medium bg-[var(--cc-canvas-soft-2)]/50 text-[var(--cc-muted)] border border-[var(--cc-hairline-strong)]/40">
                      {p}
                    </span>
                  ))}
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-body-sm font-semibold text-[var(--cc-body)]">{key.name}</p>
                      <p className="text-caption text-[var(--cc-body)] font-[var(--font-mono)]">{key.address}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="text-caption text-[var(--cc-error)] hover:text-[var(--cc-error-deep)] transition-colors px-2 py-1 rounded hover:bg-[var(--cc-error)]/10"
                    >
                      Revoke
                    </button>
                  </div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <span className="px-2 py-1 rounded text-caption font-medium bg-[var(--cc-canvas-soft-2)]/50 text-[var(--cc-muted)]">
                    Expires: {key.expiry}
                  </span>
                </div>
              </div>
        ...
        <div className="bg-[var(--cc-canvas-soft-2)]/60 backdrop-blur-xl rounded-[var(--cc-radius-md)] border border-[var(--cc-hairline-strong)]/60 overflow-hidden">
          <div className="px-5 py-4 border-b border-[var(--cc-hairline-strong)]/50 flex items-center justify-between">
            <div>
              <h2 className="text-body-lg font-semibold tracking-tighter text-[var(--cc-ink)]">⛽ Gas Sponsorship</h2>
              <p className="text-caption text-[var(--cc-body)] mt-1">Paymaster coverage — users don't pay gas</p>
            </div>
          ...
          <div className="p-5 space-y-4">
            {gasSponsored && (
              <div className="p-4 rounded-md bg-[var(--cc-success)]/10 border border-[var(--cc-success)]/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-body-sm font-semibold text-[var(--cc-success)]">Gas Sponsorship Active</p>
                    <p className="text-caption text-[var(--cc-muted)] mt-1">All transactions will be sponsored by the paymaster</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-3 gap-3">
              {MOCK_GAS_SPONSORS.map((s) => (
                <div key={s.name} className="p-3 rounded-md bg-[var(--cc-canvas)]/40 border border-[var(--cc-hairline)]/40 text-center">
                  <p className="text-caption font-semibold text-[var(--cc-body)]">{s.name}</p>
                  <p className={`text-caption font-semibold mt-1 ${
                    s.status === 'active' ? 'text-[var(--cc-success)]' : 'text-[var(--cc-warning)]'
                  }`}>
                    {s.status === 'active' ? '✓ Active' : '⚠ Limited'}
                  </p>
                  <p className="text-caption text-[var(--cc-body)] mt-1">Covers: {s.covered}</p>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="p-3 rounded-md bg-[var(--cc-canvas)]/50 border border-[var(--cc-hairline)]/50 text-center">
                <p className="text-display-md font-semibold tracking-tighter bg-gradient-to-r from-[var(--cc-link)]/80 to-[var(--cc-link)] bg-clip-text text-transparent">
                  {txCount}
                </p>
                <p className="text-caption text-[var(--cc-body)] mt-1">Gasless TXs</p>
              </div>
              <div className="p-3 rounded-md bg-[var(--cc-canvas)]/50 border border-[var(--cc-hairline)]/50 text-center">
                {/* TODO: Calculate real gas saved from on-chain data */}
                <p className="text-display-md font-semibold tracking-tighter bg-gradient-to-r from-[var(--cc-link)] to-[var(--cc-violet)] bg-clip-text text-transparent">
                  ~$2.40
                </p>
                <p className="text-caption text-[var(--cc-body)] mt-1">Gas Saved</p>
              </div>
              <div className="p-3 rounded-md bg-[var(--cc-canvas)]/50 border border-[var(--cc-hairline)]/50 text-center">
                <p className="text-display-md font-semibold tracking-tighter bg-gradient-to-r from-[var(--cc-violet)]/70 to-[var(--cc-violet-deep)]/70 bg-clip-text text-transparent">
                  0
                </p>
                <p className="text-caption text-[var(--cc-body)] mt-1">User Gas Paid</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[var(--cc-canvas-soft-2)]/60 backdrop-blur-xl rounded-[var(--cc-radius-md)] border border-[var(--cc-hairline-strong)]/60 overflow-hidden">
          <div className="px-5 py-4 border-b border-[var(--cc-hairline-strong)]/50">
            <h2 className="text-body-lg font-semibold tracking-tighter text-[var(--cc-ink)]">📦 Batch Transaction Demo</h2>
            <p className="text-caption text-[var(--cc-body)] mt-1">Execute multiple transactions in a single user operation</p>
          </div>
          ...
          <div className="p-5 space-y-3">
            ...
            {batchTxs.map((tx, i) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className={`size-6 rounded-full flex items-center justify-center text-caption font-semibold ${
                      tx.status === 'completed'
                    ...
                    <div>
                      <p className="text-body-sm font-medium text-[var(--cc-body)]">{tx.action}</p>
                      <p className="text-caption text-[var(--cc-body)] font-[var(--font-mono)]">{tx.to}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-body-sm font-semibold text-[var(--cc-body)]">{tx.amount}</p>
            ...
            {!smartAccount && (
              <p className="text-caption text-[var(--cc-body)] text-center">Create a smart account first to execute batch transactions</p>
            )}
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={f.title} className="p-3 rounded-md bg-[var(--cc-canvas)]/40 border border-[var(--cc-hairline)]/40">
                <div className="text-body-lg mb-1">{f.icon}</div>
                <p className="text-caption font-semibold text-[var(--cc-body)]">{f.title}</p>
        ...
        <div className="bg-[var(--cc-canvas-soft-2)]/60 backdrop-blur-xl rounded-[var(--cc-radius-md)] border border-[var(--cc-hairline-strong)]/60 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3 border-b border-[var(--cc-hairline-strong)]/40">
            <div className="flex items-center gap-3">
              ...
              <span className="text-caption text-[var(--cc-body)] font-[var(--font-mono)]">userop-example.ts</span>
            </div>
            <span className="text-caption px-2 py-1 rounded bg-[var(--cc-canvas-soft-2)]/50 text-[var(--cc-muted)]">TypeScript</span>
          </div>
          <pre className="p-5 text-caption text-[var(--cc-body)] font-[var(--font-mono)] overflow-x-auto leading-relaxed">
