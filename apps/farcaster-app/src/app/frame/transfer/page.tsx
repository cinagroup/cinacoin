  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 sm:p-8">
      <div className="max-w-lg w-full space-y-6 text-center">
        ...
        <h1 className="text-display-lg font-semibold text-[var(--cc-link)] flex items-center justify-center gap-2">
        ...
        <div className="bg-[var(--cc-canvas-soft-2)] rounded-2xl p-6 border border-[var(--cc-hairline)] space-y-4">
          ...
          <div className="space-y-3">
            <div className="bg-[var(--cc-canvas-soft-2)] rounded-xl p-4 text-left">
              ...
              <input
                ...
                className="w-full bg-[var(--cc-hairline-strong)] rounded-lg px-3 py-2 text-[var(--cc-on-primary)] font-[family-name:var(--font-geist-mono)] text-body-sm focus:outline-none focus:ring-2 focus:ring-[var(--cc-link)]"
              />
            </div>
            <div className="bg-[var(--cc-canvas-soft-2)] rounded-xl p-4 text-left">
          ...
          <button
            ...
            className="w-full bg-[var(--cc-link)] hover:bg-[var(--cc-link-deep)] text-[var(--cc-on-primary)] py-3 rounded-xl font-medium transition-colors"
          >
            Send transfer.
          </button>
        </div>
