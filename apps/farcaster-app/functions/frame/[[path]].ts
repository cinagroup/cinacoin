/**
 * Cloudflare Pages Function - Frame POST handler (root).
 *
 * Handles button clicks from the home frame.
 */
export async function onRequestPost(context: EventContext) {
  ...
  try {
    ...
    switch (buttonIndex) {
      case 1: redirectUrl = `${appUrl}/frame/wallet/`; break;
      case 2: redirectUrl = `${appUrl}/frame/profile/`; break;
      case 3: redirectUrl = `${appUrl}/frame/transfer/`; break;
      case 4: redirectUrl = `${appUrl}/frame/sign/`; break;
      default: redirectUrl = `${appUrl}/`;
    }
