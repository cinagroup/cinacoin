          ...
          {keys.length === 0 ? (
            ...
            keys.map((key) => (
              <tr key={key.id} className="hover:bg-canvas-soft transition-colors">
                ...
                <td className="text-ink-body text-body-sm">
                ...
                <td>
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-body-sm text-link hover:text-link-hover font-medium"
                    ...
                    {onRotate && (
                      <button
                        ...
                        className="text-body-sm text-warning hover:text-warning/80 font-medium disabled:opacity-50"
                    ...
                    <button
                      ...
                      className="text-body-sm text-danger hover:underline font-medium"
