  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <h1 className="text-2xl font-semibold text-ink mt-2">Create New Project</h1>
      ...
      <form onSubmit={handleSubmit} className="card space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-ink mb-1">Network</label>
            <select
              name="network"
              className="input"
          ...
          <div>
            <label className="block text-sm font-medium text-ink mb-1">SDK Version</label>
            <select
              name="sdkVersion"
              className="input"
