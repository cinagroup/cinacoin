  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="card space-y-4">
        ...
        <div className="flex items-center justify-between p-4 bg-canvas-soft rounded-lg">
          <div>
            <div className="text-sm font-medium text-ink">Email Notifications</div>
            <div className="text-sm text-ink-mute">Receive alerts for key events</div>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              name="notifications"
      ...
      {/* Connected Wallets */}
      <div className="card space-y-4">
        <h2 className="text-lg font-semibold text-ink">Connected Wallets</h2>
        <div className="p-4 bg-canvas-soft rounded-lg flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-2xl">🦊</span>
            <div>
              <div className="text-sm font-medium text-ink">MetaMask</div>
              <div className="text-sm text-ink-mute font-mono">0x1234...5678</div>
            </div>
          </div>
      ...
      <div className="card border-danger/30">
        <h2 className="text-lg font-semibold text-danger mb-3">Danger Zone</h2>
