    ...
    return (
      <div className="space-y-6">
        ...
        <form onSubmit={handleVerifyTotp} className="space-y-4">
          ...
          {error && (
            <div id="login-setup-totp-error" role="alert" className="p-3 bg-error/10 border border-error/20 rounded-lg text-error text-body-sm">
              {error}
            </div>
          )}
    ...
    return (
      <div className="space-y-6">
        ...
        <form onSubmit={handleVerifyTotp} className="space-y-4">
          ...
          {error && (
            <div id="login-mfa-error" role="alert" className="p-3 bg-error/10 border border-error/20 rounded-lg text-error text-body-sm">
              {error}
            </div>
          )}
  ...
  return (
    <div className="space-y-6">
      <form onSubmit={handleLogin} className="space-y-4">
        {error && (
          <div id="login-error" role="alert" className="p-3 bg-error/10 border border-error/20 rounded-lg text-error text-body-sm">
            {error}
          </div>
        )}
      ...
      <div className="grid grid-cols-3 gap-3">
        <button
          ...
          className="flex items-center justify-center px-4 py-3 border border-[var(--cc-hairline)] rounded-lg hover:bg-[var(--cc-canvas-soft)] transition-colors duration-200"
        >
