...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/[0.06] py-12 sm:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6" role="contentinfo">
        ...
        <FadeIn delay={500} direction="up">
          <div className="mt-12 sm:mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-6 sm:pt-8 md:flex-row">
            ...
            <div className="flex gap-6">
              ...
              <a href="https://discord.gg/cinacoin" aria-label="Join our Discord" className="text-zinc-600 transition-colors hover:text-white min-h-[44px] min-w-[44px] flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 rounded-full">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M20.317 4.37a19.8 19.8 0 00-4.89-1.52.07.07 0 00-.08.04c-.21.38-.44.87-.61 1.25a18.36 18.36 0 00-5.49 0c-.17-.39-.4-.87-.62-1.25a.07.07 0 00-.08-.04 19.8 19.8 0 00-4.88 1.52.07.07 0 00-.03.03C.53 9.05-.32 13.58.1 18.06a.08.08 0 00.03.06 19.9 19.9 0 006 3.03.08.08 0 00.08-.03c.46-.63.87-1.3 1.23-1.99a.08.08 0 00-.04-.11c-.65-.25-1.28-.55-1.88-.9a.08.08 0 01-.01-.13l.37-.29a.07.07 0 01.08-.01c3.93 1.8 8.18 1.8 12.07 0a.07.07 0 01.08.01c.12.1.25.2.37.29a.08.08 0 01-.01.13c-.6.35-1.23.65-1.88.9a.08.08 0 00-.04.11c.36.7.77 1.36 1.23 1.99a.08.08 0 00.08.03 19.9 19.9 0 006-3.03.08.08 0 00.03-.06c.5-5.18-.84-9.67-3.55-13.66a.06.06 0 00-.03-.03zM8.02 15.33c-1.18 0-2.16-1.09-2.16-2.42s.95-2.42 2.16-2.42c1.21 0 2.18 1.1 2.16 2.42 0 1.33-.95 2.42-2.16 2.42zm7.97 0c-1.18 0-2.16-1.09-2.16-2.42s.95-2.42 2.16-2.42c1.21 0 2.18 1.1 2.16 2.42 0 1.33-.95 2.42-2.16 2.42z" /></svg>
              </a>
            </div>
          </div>
        </FadeIn>
