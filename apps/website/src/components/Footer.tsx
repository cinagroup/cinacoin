            ...
            <FadeIn key={col.title} delay={100 + ci * 80} direction="up" duration={600}>
              <div>
                ...
                <ul className="space-y-3">
                  {col.links.map((link) => (
                    <li key={link}>
                      <a href="#" className="text-sm text-zinc-500 transition-colors hover:text-white min-h-[44px] flex items-center">
                        {link}
                      </a>
                    </li>
                  ))}
        ...
        <FadeIn delay={500} direction="up">
          <div className="mt-12 sm:mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-6 sm:pt-8 md:flex-row">
            ...
            <div className="flex gap-6">
              <a href="https://twitter.com/cinacoin" className="text-zinc-600 transition-colors hover:text-white min-h-[44px] min-w-[44px] flex items-center justify-center">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href="https://github.com/cinagroup" className="text-zinc-600 transition-colors hover:text-white min-h-[44px] min-w-[44px] flex items-center justify-center">
              ...
              <a href="https://discord.gg/cinacoin" className="text-zinc-600 transition-colors hover:text-white min-h-[44px] min-w-[44px] flex items-center justify-center">
