...
export default function Features() {
  ...
  const featureKeys = [
    { titleKey: 'f1-title', descKey: 'f1-desc' },
    { titleKey: 'f2-title', descKey: 'f2-desc' },
    { titleKey: 'f3-title', descKey: 'f3-desc' },
    { titleKey: 'f4-title', descKey: 'f4-desc' },
    { titleKey: 'f5-title', descKey: 'f5-desc' },
    { titleKey: 'f6-title', descKey: 'f6-desc' },
  ]
          ...
          {featureKeys.map((f, i) => (
            <FadeIn key={i} delay={i * 100} direction="up" duration={600}>
              <article className="cc-card">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--cc-canvas-soft-2)] text-[var(--cc-ink)]">
                  {featureIcons[i]}
                </div>
