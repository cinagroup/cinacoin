export const enTranslations = {
  ...
  'f3-desc':
    'Sign-In With Ethereum (EIP-4361) with session management, wallet verification, and passkey support.',
  'f4-title': 'Real-time notifications.',
  'f4-desc':
    'Push notifications for wallet activity, transaction confirmations, and cross-chain events via Push server.',
  'f5-title': 'Developer-first SDKs.',
  'f5-desc':
    'Clean TypeScript SDKs for React, Vue, Svelte, and more. Comprehensive docs and live demo examples.',
  'relay-desc':
    'WebSocket relay server for cross-chain messaging — routes real-time connections between wallets, dApps, and blockchain networks.',
  'keys-desc':
    'Secure key management service — encrypted storage, rotation, and retrieval of session, signing, and encryption keys with audit logging.',
  'rpc-desc':
    'Multi-provider RPC proxy with intelligent routing, Redis caching, automatic failover, and deduplication across 16+ blockchain networks.',
  'f6-title': 'Fully open source.',
  'f6-desc':
    'Self-hosted, zero vendor lock-in. MIT licensed with full transparency and community contributions.',
  ...
  'products-keys-desc':
    'Encrypted key management with rotation, audit logging, and secure retrieval.',
  ...
  'solutions-enterprise-desc':
    'Blockchain infrastructure for businesses. Private chains, compliance tools, and dedicated support.',
  ...
  'solutions-performance-desc':
    'Our consensus mechanism delivers sub-second finality and 100,000+ TPS.',
  ...
  'solutions-scale-desc':
    'Deploy globally with nodes across 50+ regions and automatic load balancing.',
  ...
  'about-p1-desc':
    'Every SDK, adapter, and tool is MIT licensed on GitHub. No black boxes, no vendor lock-in. You own your stack.',
  'about-p2-icon': 'globe',
  'about-p2-title': 'Chain agnostic.',
  'about-p2-desc':
    "EVM, Solana, Bitcoin, Cosmos, TON, Sui — we support 16+ chains and counting. Your users shouldn't care which chain they're on.",
  'about-p3-icon': 'zap',
  'about-p3-title': 'Developer experience.',
  'about-p3-desc':
    'Clean APIs, comprehensive docs, and framework adapters for React, Vue, Svelte, and more. Build in minutes, not days.',
  'about-p4-icon': 'shield',
  'about-p4-title': 'Self-hosted.',
  'about-p4-desc':
    'Run everything on your own infrastructure. No data leaves your servers unless you want it to.',
  ...
  'privacy-s2-l1':
    '<strong>Account Information:</strong> Email address, name, and organization details when you create an account.',
  'privacy-s2-l2':
    '<strong>Usage Data:</strong> API usage metrics, request counts, and service interaction logs.',
  'privacy-s2-l3':
    '<strong>Technical Data:</strong> IP addresses, browser type, operating system, and device information.',
  'privacy-s2-l4':
    '<strong>Blockchain Data:</strong> Public wallet addresses and transaction hashes processed through our infrastructure (note: blockchain data is inherently public).',
  ...
  'privacy-s9-p':
    'We use cookies and similar tracking technologies. For more information, please see our <a href="/cookies">Cookie Policy</a>.',
  ...
  'cookies-s6-l2':
    '<strong>Persistent cookies:</strong> Remain on your device for a specified period (typically 30 days to 1 year)',
  ...
  'cookies-s8-p':
    'If you have questions about our use of cookies, please contact us at <a href="/contact">our Contact page</a>.',
  // Search
