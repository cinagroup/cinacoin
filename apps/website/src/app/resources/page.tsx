      ...
      <section className="max-w-[1200px] mx-auto px-6 pb-24">
        <div className="grid md:grid-cols-2 gap-6">
          <div id="whitepaper" className="p-6 bg-[var(--cc-canvas)] border border-[var(--cc-hairline)] rounded-[var(--cc-radius-md)] shadow-[var(--cc-level1)]">
            <h2 className="text-display-md font-semibold mb-3 text-[var(--cc-ink)]">{t('resources-whitepaper-title')}</h2>
            <p className="text-[var(--cc-body)] text-body-sm leading-relaxed mb-4">
              {t('resources-whitepaper-desc')}
            </p>
            <span className="inline-flex items-center text-body-sm font-medium text-[var(--cc-link)]">
          ...
          <div id="blog" className="p-6 bg-[var(--cc-canvas)] border border-[var(--cc-hairline)] rounded-[var(--cc-radius-md)] shadow-[var(--cc-level1)]">
            <h2 className="text-display-md font-semibold mb-3 text-[var(--cc-ink)]">{t('resources-blog-title')}</h2>
            <p className="text-[var(--cc-body)] text-body-sm leading-relaxed mb-4">
          ...
          <div id="community" className="p-6 bg-[var(--cc-canvas)] border border-[var(--cc-hairline)] rounded-[var(--cc-radius-md)] shadow-[var(--cc-level1)]">
            <h2 className="text-display-md font-semibold mb-3 text-[var(--cc-ink)]">{t('resources-community-title')}</h2>
            <p className="text-[var(--cc-body)] text-body-sm leading-relaxed mb-4">
              {t('resources-community-desc')}
            </p>
            <div className="flex gap-3">
              <span className="px-3 py-1 bg-[var(--cc-canvas-soft-2)] rounded-[4px] text-caption font-medium text-[var(--cc-body)]">Discord</span>
              <span className="px-3 py-1 bg-[var(--cc-canvas-soft-2)] rounded-[4px] text-caption font-medium text-[var(--cc-body)]">Twitter</span>
              <span className="px-3 py-1 bg-[var(--cc-canvas-soft-2)] rounded-[4px] text-caption font-medium text-[var(--cc-body)]">Telegram</span>
            </div>
          </div>
          ...
          <div id="support" className="p-6 bg-[var(--cc-canvas)] border border-[var(--cc-hairline)] rounded-[var(--cc-radius-md)] shadow-[var(--cc-level1)]">
            <h2 className="text-display-md font-semibold mb-3 text-[var(--cc-ink)]">{t('resources-support-title')}</h2>
            <p className="text-[var(--cc-body)] text-body-sm leading-relaxed mb-4">
