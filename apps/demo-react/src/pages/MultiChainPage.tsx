...
const CHAINS = [
  ...
  },
  {
    ...
    name: 'Arbitrum',
    symbol: 'ARB',
    color: 'var(--cc-demo-chain-arbitrum)',
    icon: 'λ',
  ...
  },
  {
    ...
    name: 'Optimism',
    symbol: 'OP',
    color: 'var(--cc-demo-chain-optimism)',
    icon: 'O',
  ...
  },
  {
    ...
    name: 'Solana',
    symbol: 'SOL',
    color: 'var(--cc-demo-chain-solana)',
    icon: '◎',
  ...
  },
  {
    ...
    name: 'Bitcoin',
    symbol: 'BTC',
    color: 'var(--cc-demo-chain-bitcoin)',
    icon: '₿',
  ...
  },
  {
    ...
    name: 'TRON',
    symbol: 'TRX',
    color: 'var(--cc-demo-chain-tron)',
    icon: 'T',
    wallets: ['TronLink', 'TronPay'],
    txs: '4.8M',
    tvl: '$8B',
  },
  {
    ...
    name: 'Cosmos',
    symbol: 'ATOM',
    color: 'var(--cc-demo-chain-cosmos)',
    icon: 'C',
    wallets: ['Keplr', 'Leap'],
    txs: '1.1M',
    tvl: '$2.5B',
  ...
  },
  {
    ...
    name: 'Starknet',
    symbol: 'STRK',
    color: 'var(--cc-demo-chain-starknet)',
    icon: 'S',
  ...
  },
  {
    ...
    name: 'NEAR',
    symbol: 'NEAR',
    color: 'var(--cc-demo-chain-near)',
    icon: 'N',
    wallets: ['NEAR Wallet', 'Here Wallet'],
    txs: '1.5M',
    tvl: '$800M',
  },
  {
    ...
    name: 'Hedera',
    symbol: 'HBAR',
    color: 'var(--cc-demo-chain-hedera)',
    icon: 'H',
  ...
  },
  {
    ...
    name: 'XRPL',
    symbol: 'XRP',
    color: 'var(--cc-demo-chain-xrpl)',
    icon: 'X',
    wallets: ['Xaman', 'Fireblocks'],
    txs: '650K',
    tvl: '$200M',
  },
];
  ...
  return (
    <section className="max-w-5xl mx-auto w-full py-12 px-4" aria-label="Multi-chain support">
      <div className="mb-10">
        ...
        <p className="cc-body-md text-[var(--cc-body)] max-w-2xl">
          EVM · Solana · Bitcoin · Layer 2s — unified API, zero fragmentation
        </p>
      </div>
          ...
          >
            ...
            <div className="flex gap-1 flex-wrap">
              {c.wallets.slice(0, 3).map((w) => (
                <span
                  key={w}
                  className="cc-badge !bg-[var(--cc-canvas-soft-2)] text-[10px] py-1 px-2"
                >
                  {w}
                </span>
              ))}
      ...
      {chain && (
        <div className="cc-card-lg mb-8 animate-slide-up border border-[var(--cc-link)]/10">
          ...
          <button
            ...
            onClick={() => {
              /* Demo: would trigger chain connection flow */
            }}
          >
            Connect {chain.name}
          </button>
...
const btc = await cc.connect('bitcoin', 'xverse');`}
        </pre>
      </div>
