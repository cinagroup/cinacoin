...
const WalletModal: React.FC<WalletModalProps> = ({ isOpen, onClose }) => {
 ...
 <div className="w-20 h-20 rounded-full border-2 border-[var(--cc-hairline)]" />
 <div
 ...
 <p className="text-[var(--cc-muted)] text-sm mb-4">
 Opening {selectedWallet.name}...
 </p>
 <p className="text-[var(--cc-muted)] text-xs">
 ...
 {address && (
 <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--cc-canvas-soft)]/50 text-sm text-[var(--cc-body)] font-mono">
 ...
 <div className="flex flex-col items-center justify-center py-12 px-6">
 {/* Error icon */}
 <div className="w-20 h-20 rounded-full bg-[var(--cc-error)]/15 flex items-center justify-center mb-6 animate-bounce-in">
 ...
 {/* Footer */}
 {modalState === 'open' && (
 <div className="px-6 py-3 border-t border-[var(--cc-hairline)] flex items-center justify-between text-xs text-[var(--cc-muted)]">
