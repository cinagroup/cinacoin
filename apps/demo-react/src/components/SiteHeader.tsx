          ...
          <div className="hidden sm:block">
            {isConnected ? (
              ...
              <button
                ...
                className="cc-btn-primary-sm text-body-sm focus-ring"
            ...
            <nav className="fixed right-4 top-16 z-50 w-56 bg-[var(--cc-canvas)] border border-[var(--cc-hairline)] rounded-[var(--cc-radius-md)] shadow-[var(--cc-level5)] p-2 sm:hidden" aria-label="Mobile navigation">
              ...
              {isConnected ? (
                <button
                  ...
                  className="block w-full px-4 py-3 rounded-[var(--cc-radius-sm)] text-body-sm font-medium text-[var(--cc-error)] transition-colors min-h-[44px] flex items-center hover:bg-[var(--cc-canvas-soft)]"
                >
                  Disconnect
                </button>
              ) : (
                <button
                  ...
                  className="block w-full px-4 py-3 rounded-[var(--cc-radius-sm)] text-body-sm font-medium text-[var(--cc-link)] transition-colors min-h-[44px] flex items-center hover:bg-[var(--cc-canvas-soft)]"
                >
                  Connect Wallet
                </button>
              )}
