    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--cc-canvas-soft)] px-4">
      <div className="w-full max-w-md">
        <div className="bg-[var(--cc-canvas)] rounded-md shadow-level-2 p-8">
          ...
          {error && (
            <div id="cloud-login-error" role="alert" className="mb-4 p-3 bg-[var(--color-error-soft)] border border-[var(--color-error)]/20 rounded text-body-sm text-[var(--color-error-deep)]">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {!showTwoFactor ? (
              <>
                <div>
                  ...
                  <input
                    ...
                    aria-required="true"
                    aria-invalid={!!error}
                    aria-describedby={error ? "cloud-login-error" : undefined}
                    autoFocus
                    disabled={loading}
                  />
                </div>
              ...
              <div>
                <label htmlFor="twoFactorCode" className="block text-body-sm font-medium text-[var(--cc-ink)] mb-2">
                  Authentication code.
                </label>
                <input
                  id="twoFactorCode"
                  ...
                  aria-required="true"
                  aria-invalid={!!error}
                  aria-describedby={error ? "cloud-login-error" : "cloud-mfa-help"}
                  autoFocus
                  maxLength={6}
                  inputMode="numeric"
                  ...
                  disabled={loading}
                />
                <p id="cloud-mfa-help" className="text-caption text-[var(--cc-muted)] mt-2 text-center">
                  Enter the 6-digit code from your authenticator app.
                </p>
              </div>
            )}
