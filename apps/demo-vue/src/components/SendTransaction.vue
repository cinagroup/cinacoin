...
.btn-xs:hover:not(:disabled) { background: var(--cc-canvas-soft, #141414); opacity: 1; }
.btn-xs:disabled { opacity: 0.5; cursor: not-allowed; }
.btn-primary { background: var(--cc-primary); color: var(--cc-on-primary); }
.btn-primary:disabled { opacity: 0.5; cursor: not-allowed; }
.btn-outline { background: transparent; border: 1px solid var(--cc-hairline, rgba(255, 255, 255, 0.08)); color: var(--cc-ink, #f5f5f5); border-radius: 4px; }
...
.gas-value { font-size: 0.875rem; color: var(--cc-link, #3b82f6); font-family: var(--font-mono, 'Geist Mono'), monospace; }
...
.result-box {
  background: var(--cc-canvas-soft-2, #1e1e1e); border-radius: 4px; padding: 0.75rem; margin-top: 0.5rem;
}
.result-box.success { border: 1px solid var(--cc-success, #22c55e); }
