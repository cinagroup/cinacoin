...
chains:
  - id: 1
    ...
    symbol: ETH
    type: evm
    rpc_url: "https://rpc.onchainux.com/eth"
    ws_url: "wss://rpc.onchainux.com/eth/ws"
  ...
  - id: 137
    ...
    symbol: MATIC
    type: evm
    rpc_url: "https://rpc.onchainux.com/polygon"
    ws_url: "wss://rpc.onchainux.com/polygon/ws"
  ...
  - id: 101
    ...
    symbol: SOL
    type: solana
    rpc_url: "https://rpc.onchainux.com/solana"
    ws_url: "wss://rpc.onchainux.com/solana/ws"
  ...
  - name: relay-global
    ...
    pools:
      - name: us-east-1
        ...
        origins:
          - name: relay-us-east
            address: relay-us-east.onchainux.com
            enabled: true
            weight: 50
        check:
          type: tcp
      ...
      - name: eu-central-1
        ...
        origins:
          - name: relay-eu-west
            address: relay-eu-west.onchainux.com
            enabled: true
            weight: 30
        check:
          type: tcp
      ...
      - name: ap-southeast-1
        ...
        origins:
          - name: relay-apac
            address: relay-apac.onchainux.com
            enabled: true
            weight: 20
        check:
          type: tcp
