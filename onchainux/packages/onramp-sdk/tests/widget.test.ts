...
// ============================================================
// Tests for @onchainux/onramp-sdk OnRampWidget
// ============================================================
...
vi.stubGlobal('document', {
  getElementById: vi.fn((id: string) => {
    if (id === 'onramp-widget') return mockContainer;
    return null;
  }),
...
describe('OnRampWidget', () => {
  ...
  describe('open', () => {
    ...
    it('should open as embedded iframe when popup is false', async () => {
      ...
      const messageHandler = (window.addEventListener as ReturnType<typeof vi.fn>).mock.calls[0][1];
      messageHandler({
        data: {
  ...
  describe('close', () => {
    it('should close popup window', () => {
      ...
      (widget as unknown as Record<string, unknown>).popupWindow = mockPopup;
    ...
    it('should remove iframe in embedded mode', () => {
      ...
      // Manually set iframe
      (widget as unknown as Record<string, unknown>).iframe = mockIframe;
