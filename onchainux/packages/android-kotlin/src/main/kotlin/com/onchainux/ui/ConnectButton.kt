...
import com.onchainux.core.AccountInfo
import com.onchainux.core.ConnectionStatus
import com.onchainux.core.OnChainUX
import com.onchainux.core.ThemeColors
...
private fun handleButtonPress(
    ...
    scope.launch {
        try {
            ...
            onPress?.invoke()
        } catch (_: Exception) { /* handled by OnChainUX state */ }
    }
}
