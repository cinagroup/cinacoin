# CinaAuth/OnChainUX vs Reown — 综合差距分析报告
...
> **功能覆盖率约 25-30%** — 设计架构优秀但实现严重不足。OnChainUX 在基础设施广度和智能账户深度上有超越 Reown 的潜力，但需要先填补核心 SDK 和开发者生态的缺口。
...
## ✅ OnChainUX 领先 Reown 的领域

| 领域 | OnChainUX | Reown | 说明 |
|------|:---------:|:-----:|------|
