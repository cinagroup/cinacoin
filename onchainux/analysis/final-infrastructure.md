# FINAL Detailed Infrastructure Comparison: CinaAuth/OnChainUX vs Reown
...
The previous analysis (02-infrastructure.md) assessed CinaAuth/OnChainUX based on design documents and Helm manifests. **This report is different — it reviews actual source code.** The findings are mixed: OnChainUX has **implemented more services than the prior report assumed**, but **deep code-level review reveals significant gaps in production readiness**.
...
| Helm deployment | `deploy/helm/onchainux/` | ❌ Missing | Not in values.yaml or templates |
...
| Helm | `deploy/helm/onchainux/templates/relay/` | ✅ Complete | Deployment, HPA, Service, Ingress with TLS |
...
*Report generated 2026-05-16 | Source-level analysis of all CinaAuth/OnChainUX infrastructure packages*
