 ...
 */
Cypress.Commands.add('connectWallet', (walletName) => {
 ...
 */
Cypress.Commands.add('switchNetwork', (chainId) => {
    ...
    cy.get('[data-testid="network-selector"]').should('have.attr', 'data-active-chain-id', String(chainId));
});
/**
 * cy.signTransaction()
 *
