...
- Name: deployed-visual-regression.spec.ts >> Design System Compliance Check >> buttons use pill shape (100px border-radius)
- Location: tests/deployed-visual-regression.spec.ts:152:7
