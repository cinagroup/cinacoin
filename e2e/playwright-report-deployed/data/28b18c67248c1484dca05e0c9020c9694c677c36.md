...
- Name: deployed-visual-regression.spec.ts >> Deployed Applications Visual Regression >> health status page loads correctly
- Location: tests/deployed-visual-regression.spec.ts:100:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_CLOSED at https://health.cinacoin.com/
Call log:
  - navigating to "https://health.cinacoin.com/", waiting until "load"
